...
router.post('/',                     requirePermission(PERMISSIONS.CUSTOMERS_CREATE), v.validateCreate, ctrl.create);
router.get('/:id',                   requirePermission(PERMISSIONS.CUSTOMERS_READ),   ctrl.getById);
router.put('/:id',                   requirePermission(PERMISSIONS.CUSTOMERS_UPDATE), v.validateUpdate, ctrl.update);
router.patch('/:id',                 requirePermission(PERMISSIONS.CUSTOMERS_UPDATE), v.validateUpdate, ctrl.update);
