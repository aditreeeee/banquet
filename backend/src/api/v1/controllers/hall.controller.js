...
const remove         = async (req, res) => { await svc.remove(parseInt(req.params.id, 10), actor(req)); return response.success(res, null, 'Hall deleted'); };
...
module.exports = { getAll, getById, create, update, activate, deactivate, remove, getAvailability, block, unblock };
