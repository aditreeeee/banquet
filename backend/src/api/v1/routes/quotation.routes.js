...
router.post('/',                   requirePermission(PERMISSIONS.QUOTATIONS_CREATE), ctrl.create);
...
router.put('/:id',                 requirePermission(PERMISSIONS.QUOTATIONS_UPDATE), ctrl.update);
router.post('/:id/items',          requirePermission(PERMISSIONS.QUOTATIONS_UPDATE), ctrl.addItem);
...
router.post('/:id/convert',        requirePermission(PERMISSIONS.QUOTATIONS_APPROVE), ctrl.convert);
